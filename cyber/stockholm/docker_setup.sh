...
# Config
docker_destination="/sgoinfre/Perso/$USER/docker" #=> Select docker destination (goinfre is a good choice)
...
unlink ~/Library/Containers/com.docker.docker/backend.lock &>/dev/null ;:
...
ln -sf "$docker_destination"/com.docker.docker/backend.lock  ~/Library/Containers/com.docker.docker/backend.lock
