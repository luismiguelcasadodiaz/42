...
def ft_filter(fun, ite):
    ...
    """
    try:
        if not ite is None and not fun is None:
            ...
            msg = f"Can not filter object {ite} with function {fun}"
...
if __name__ == '__main__':
    ...
    print("==>ft_filter(filter_b, {1:1,2:2,3:3,4:4,5:'b',6:6,7:7,8:8,9:9,10:10}")
    print(ft_filter(filter_b, {1:1,2:2,3:3,4:4,5:'b',6:6,7:7,8:8,9:9,10:10}))
